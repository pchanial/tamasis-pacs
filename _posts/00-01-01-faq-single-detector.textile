...
A @PacsObservation@ gathers information about the instrument settings, which are stored in the @instrument@ attribute.  With the exception of the detector channel, the parameters in the @instrument@ attribute can be modified after instantiation. More information can be found on "what contains a PacsObservation":/tamasis-map/2000/faq-what-is-a-pacsobservation/.
