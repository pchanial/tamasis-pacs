...
* "pyoperators":http://pchanial.github.com/pyoperators >= 0.2
...
<h3>Optional:</h3>
* "ds9":http://hea-www.harvard.edu/saord/ds9/pyds9
* "mpi4py":http://mpi4py.scipy.org

h2. Other

* "gfortran":http://gcc.gnu.org >= 4.5 or ifort >= 11.1
...
* "openmpi":http://www.open-mpi.org or "mpich":http://www.mcs.anl.gov/research/projects/mpich2
