...
subroutine pointing_matrix_mask(pmatrix, mask1d, npixels_per_sample, nsamples, npixels)
...
subroutine pointing_matrix_pack(pmatrix, mask1d, npixels_per_sample, nsamples, npixels)
